...
import com.moboleStore.app.config.JwtTokenUtil;
import com.moboleStore.app.config.JwtUserDetailsService;
import com.moboleStore.app.dto.AddUserDto;
import com.moboleStore.app.dto.JwtRequest;
import com.moboleStore.app.dto.JwtResponse;
...
public class JwtAuthenticationController {
	...
	public ResponseEntity<?> createAuthenticationToken(@RequestBody JwtRequest authenticationRequest) throws Exception {
		...
		return ResponseEntity.ok(new JwtResponse("Bearer "+token,userDetails.getAuthorities().toString()));
	}
